        ...
        with self.database.session() as session:
            for record in records:
                ...
                values = {
                    ...
                    "open_price": self._finite(record.get("open_price")),
                    "high_price": self._finite(record.get("high_price")),
                    "low_price": self._finite(record.get("low_price")),
                    "close_price": self._finite(record.get("close_price")),
                    "volume": self._finite(record.get("volume")),
                    "turnover": self._finite(record.get("turnover")),
                    "turnover_rate": self._finite(record.get("turnover_rate")),
